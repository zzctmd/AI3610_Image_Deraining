...
parser.add_argument('--gpu_ids', type=str, default='6', help='gpu ids: e.g. 0  0,1,2, 0,2. -1 for CPU')
parser.add_argument('--data_path', type=str, default='/data/user/zzcnb123456/ESDNet-master/data/RW-Data')
parser.add_argument('--save_path', type=str, default='/data/user/zzcnb123456/ESDNet-master/result/LOSS_RW_data')
...
parser.add_argument('--weights', type=str, default='/data/user/zzcnb123456/ESDNet-master/pretrained_models/Rain200H/model.pth')
